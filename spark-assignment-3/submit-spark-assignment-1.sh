...
JARFILE=`pwd`/target/scala-2.12/moviedatabaseanalyzer-assembly-0.1.0-SNAPSHOT.jar

# Run it locally
${SPARK_HOME}/bin/spark-submit --class MovieDatabaseAnalyzer --master local $JARFILE
